// Medium_Level.java : Defines the medium level for the java application.
 ...
 * @author Shweta
 */
public class Medium_Level extends Canvas implements MouseListener, MouseMotionListener{
    //Constructor
    public Medium_Level(){
    ...
    Rectangle obstacle1 = new Rectangle(200, 360, 70, 70);
    Rectangle obstacle2 = new Rectangle(380, 200, 90, 90);
    ...
    public static void main(String[] args) {
        ...
        Medium_Level canvas = new Medium_Level();
        //Set Window Size

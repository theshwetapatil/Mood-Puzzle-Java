// Easy_Level.java : Defines the easy level for the java application.
 ...
 * @author Shweta
 */
public class Easy_Level extends Canvas implements MouseListener, MouseMotionListener{
    //Constructor
    public Easy_Level(){
    ...
    boolean checkLoose(){
        if(obstacle1.contains(rect) || obstacle2.contains(rect))
        {
    ...
    public static void main(String[] args) {
        ...
        Easy_Level canvas = new Easy_Level();
        //Set Window Size
